...
<div class="code c highlight-python"><pre>cat << END >> $NGX_AUTO_CONFIG_H
...
<pre class="code c literal-block"><span class="comment preproc">#ifndef NGX_HAVE_UNISTD_H
...
<div class="code c highlight-python"><pre>if test -n "$NGX_ADDONS"; then
